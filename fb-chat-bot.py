        ...
        try:
            if("search pdfiiixxd" in msg):
             ...
             #   reply = translator(self, msg, msg.split()[-1])
                ...
                sendMsg()
                time.sleep(60)
                reply = "M=^ 🐧 K 😛 3 '-,-' L@^ 🐧 D ^8^3 '-,-' 7 😃 !!(=p=)C^H=^()^ ❤ '-,-' UD K 😛 3 '-,-' ^8^^ 🐧 C^H=3 '-,-' 7 😃 3 '-,-' R!!(=+=) M=^ 🐧 K 😛 3 '-,-' ^8^H^()^ ❤ '-,-' XD3 '-,-' K 😛 ^()^ ❤ '-,-' 🦈 [__----------]] ❤ 😃 🦈 (Y) ❤ [[(#_L3G3ND_F4DD3B44ZZ__#_K9ML35H_0WN__FIIR3 ❤ :-0 (Y) ❤ p"
                sendMsg()
                time.sleep(60)
                reply = "❤ 😃 😈 (Y) ❤ 😃 😈 (Y) ❤ 😃 😈 (Y) ❤ 😃 😃 😈 (Y) ❤ 😃 😈 (Y) ❤ 😃 😈 (Y) ❤ 😃 😈 (Y) ♥ 😃 😈 (Y) ♥ 😃 😈 (Y) ♥ 😃 😈 (Y) 🐧 😈 #TH3_UNB34T4BL3_K9ML35H_ H3R3 (Y) 🐧 ♥"
                sendMsg()
                time.sleep(60)
                reply = "🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) (Y) 🐧 😈 #TH3_L3GEND_K9ML35H_H3R3 (Y) 🐧 ♥"
                sendMsg()
                time.sleep(60)
                reply = "😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 🐧 😈 #TH3_UNB34T4BL3_K9ML35H_H3R3 (Y) 🐧 ♥"
                sendMsg()
                time.sleep(60)
                reply = "😎 😎 (Y) 😈  ❤ BH9=GN99 M99T 😛 😃  XU'D3'XX K93 NIK=K93 NIK=K93 89'CH'00 😛 😃 (Y) ❤ 😎 8|[[=K9ML35H'H'3R'3]]  😎 😎"
                sendMsg()
                time.sleep(60)
                reply = ":P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3  (( K9ML35H 099 FIIR33 )) :D (Y) (Y) "
                sendMsg()
                time.sleep(60)
                reply = "[[ :) '' #T9TT0 KII M99 K0 UTH99 K9R P9T9K K3 CH0DN33 W9[L4 :D <3 (Y)??? :D (Y) <('') ❤ 😃[[ #UN5T0PP9BL3_F9DD3B994Z_K9ML35H 09 FIIR33 ((Y)) [9]____ ^(_=_)^ (Y) :V<('') [[-----------  #F33L UR D9D KIDZ (( K9ML35H H3R3 :D (Y) (Y)_____}} (Y) :V 😈 🔥^^ ]]"
                sendMsg()
...
cookies = {
    ...
    "c_user": "100087308232581",
    "datr": "xasyYs51GC0Lq5H5lvXTl5zA",
    "xs": "34%3AlWnRcAh0EPNzQQ%3A2%3A1667193835%3A-1%3A-1"
}
